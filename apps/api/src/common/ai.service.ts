  ...
  async generateFortune(data: FortunePromptData): Promise<AIResponse | null> {
    ...
    try {
      return await this.callAI(prompt, {
        ...
        timeout: 100000, // 增加到100秒，确保AI有足够时间生成
      });
    } catch (error) {
...
2. 分析内容应包括事业、财富、爱情、健康四方面。
3. 提供的运势分析要详细且具有一定的深度和专业性。
4. 根据分析结果进行总结，提供7项数据：事业运星数、财富运星数、爱情运星数、健康运星数、建议、避免事项、今日宜、今日喜用、今日幸运色和幸运数字、综合分数。
...
【重要】详细说明格式要求：
- 今日宜详细说明：1-2句话，简洁明了地解释为什么今日适合做这件事，约30-50字
- 今日喜用详细说明：1-2句话，简洁明了地解释这个元素对今日运势的帮助，约30-50字
- 幸运元素详细说明：1-2句话，简洁明了地解释幸运色和幸运数字的作用，约30-50字
...
其他事项:
今日宜:[不超过10字]
今日宜详细说明:[1-2句话，约30-50字，解释为什么今日适合做这件事]
今日喜用:[不超过10字]
今日喜用详细说明:[1-2句话，约30-50字，解释这个元素对今日运势的帮助]
今日幸运色:[不超过10字]
今日幸运数字:[1-2位数字]
幸运元素详细说明:[1-2句话，约30-50字，解释幸运色和幸运数字的作用]
今日运势综合数字:[0-100的整数]
