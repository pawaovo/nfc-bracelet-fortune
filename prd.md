...
* **NFR5: 技术栈**:
    ...
    * NFR5.3: 小程序基于 uni-app 框架开发，目标平台为微信小程序。 *(注：uni-app 是后续架构阶段确定的)*
* **NFR6: 可维护性**:
...
* **前端平台**: 应用将作为**微信小程序**开发和发布。 *(后续确定使用 uni-app 框架)*
* **开发语言与框架**: （待定）具体的前后端开发语言和框架将在技术架构设计阶段确定，需考虑微信小程序生态、PostgreSQL 交互以及 API 对接的便利性。 *(后续确定为 uni-app(Vue3+TS) + NestJS)*
